  ...
  return (
    <div className="card mb-4 sm:mb-6">
      <div className="flex items-center justify-between mb-3 sm:mb-4">
        <h2 className="card-title">Network Earnings Panel</h2>
      ...
      {!hasAnyActivity ? (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-center">
          <p className="text-gray-700 font-semibold">No Network Activity</p>
          <p className="text-sm text-gray-600 mt-2">
            Your network earnings will appear here when your miners buy mining power or licenses.
          </p>
        </div>
      ) : (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4">
            ...
            <div className="bg-slate-50 rounded-md border border-slate-200 p-3 sm:p-4">
              ...
              <p className="text-xs text-gray-500 mt-1">Net ZOD</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-4">
            <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
              <h3 className="text-sm font-bold text-gray-800 mb-2">Mining Boost (Power Increase)</h3>
            ...
            <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
              <h3 className="text-sm font-bold text-gray-800 mb-2">Network Bonus (Instant Mint)</h3>
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-xs text-gray-600">Received:</span>
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-lg p-3 sm:p-4 mb-4">
            <h3 className="text-base font-bold text-gray-800 mb-3">USD Statistics</h3>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              ...
              <div className="bg-white rounded-lg p-3 border border-indigo-200">
                <p className="text-xs text-gray-600">Redistribution (This Month)</p>
                <p className="text-lg font-bold text-indigo-700">${monthlyStats.redistributionReceivedUSD}</p>
              </div>

              <div className="bg-white rounded-lg p-3 border border-indigo-200">
                <p className="text-xs text-gray-600">Earnings (Lifetime)</p>
                <p className="text-lg font-bold text-purple-700">${monthlyStats.lifetimeNetworkEarningsUSD}</p>
              </div>

              <div className="bg-white rounded-lg p-3 border border-indigo-200">
                <p className="text-xs text-gray-600">Redistribution (Lifetime)</p>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
            ...
            <ul className="text-xs text-gray-600 mt-2 space-y-1 list-disc list-inside">
              <li><strong>Mining Boost:</strong> Increases your mining power when miners buy power</li>
              <li><strong>Network Bonus:</strong> Instant ZOD tokens when miners buy licenses</li>
              <li><strong>Qualification:</strong> Level 1 requires active mining. Levels 2-6 require active license.</li>
              <li><strong>Lost Earnings:</strong> Happens when you are not qualified at the moment of activity</li>
              <li><strong>Monthly Tax:</strong> Earnings above $500/month are progressively taxed for redistribution</li>
            </ul>
          </div>
        </>
      )}
